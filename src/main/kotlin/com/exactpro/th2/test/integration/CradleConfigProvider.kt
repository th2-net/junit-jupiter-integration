...
internal object CradleConfigProvider {
    ...
    fun getCradleParametersConfig(
        spec: CradleSpec,
        prepareStorage: Boolean = false,
    ): CombinedCassandraStorageSettings {
...
internal class CombinedCassandraStorageSettings(
    ...
    @property:Suppress("unused") @field:JsonUnwrapped val settings: CassandraStorageSettings,
)
